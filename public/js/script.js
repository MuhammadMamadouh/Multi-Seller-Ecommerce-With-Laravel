...
//grid layout view
  ...
  /*=====================
   10. Product page Quantity Counter
   ==========================*/
  $('body .qty-box .quantity-right-plus').on('click', function () {
  ...
  $('body .qty-box .quantity-left-minus').on('click', function () {
    var $qty = $('.qty-box .input-number');
    var currentVal = parseInt($qty.val(), 10);
  ...
  var qtyDecs = document.querySelectorAll("body .qty-minus");
  var qtyIncs = document.querySelectorAll("body .qty-plus");
  ...
  $('.account-sidebar').on('click', function(e) {
    $('.user-left').css("left","0");
  });
  $('.filter-back').on('click', function(e) {
    $('.user-left').css("left","-365px");
  });
