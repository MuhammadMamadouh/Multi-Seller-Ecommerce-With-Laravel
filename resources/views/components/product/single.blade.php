    ...
    <div class="product-box">
        <div class="product-imgbox">
            <div class="product-front">
                <a href="{{route('product.details', $item->id)}}"> <img src="{{asset("storage/"). '/' .  json_decode($item->images, true)[0]}}" class="img-fluid  " alt="product"> </a>
            </div>
            <div class="product-back">
                <a href="{{route('product.details', $item->id)}}"> <img src="{{asset("storage/"). '/' .  json_decode($item->images, true)[1]}}" class="img-fluid  " alt="product"> </a>
            </div>
        </div>
        <div class="product-detail detail-center detail-inverse">
            ...
            <div class="icon-detail">
                <button class="tooltip-top add-cartnoty" data-tippy-content="Add to cart" data-product-id="{{$item->id}}"> <i  data-feather="shopping-cart"></i> </button>

                <a href="javascript:void(0)"  class="add-to-wish tooltip-top"  data-tippy-content="Add to Wishlist" > <i  data-feather="heart"></i> </a>

                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#quick-view-{{$item->id}}" class="tooltip-top"  data-tippy-content="Quick View"> <i  data-feather="eye"></i> </a>
...
<div class="modal fade bd-example-modal-lg theme-modal" id="quick-view-{{$item->id}}" tabindex="-1" role="dialog"
     aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img">
                            <img src="{{asset("storage/$item->photo")}}" alt="" class="img-fluid bg-img">
                        </div>
                    </div>
...
{{--                                    <h6 class="error-message">please select size</h6>--}}
                                    <div class="size-box">
                                        <ul>
                                            @foreach($item->sizes as $size )
                                                <li><a href="javascript:void(0)">{{$size->name}}</a></li>
                                            @endforeach
                                    ...
                                    <div class="color-selector inline">
                                        <ul>
                                            @foreach($item->colors as $color)
                                                <li><div class="color-1" style="background-color: {{$color->color}}"></div></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                @endisset
                                ...
                                <div class="product-buttons">
                                    ...
                                    <a href="{{route('product.details', $item->id)}}" class="btn btn-normal tooltip-top"
