                        ...
                        <div class="language-block">
                            <div class="language-dropdown">
                                  <span class="language-dropdown-click">
                                    {{getDefaultLang()->name}} <i class="fa fa-angle-down" aria-hidden="true"></i>
                                  </span>
                                <ul class="language-dropdown-open">
                                    @foreach(\App\Models\Language::active()->get() as $lang)
                                        <li><a href="{{route('lang.change', $lang->id)}}">{{$lang->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                               ...
                               M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z"></path>
                                ...
                                <li class="mobile-setting">
                                    <a href="javascript:void(0)">
                                        <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512"
                                            ...
                                            <path
                                                d="m256 367.4c-61.427 0-111.4-49.974-111.4-111.4s49.973-111.4 111.4-111.4 111.4 49.974 111.4 111.4-49.973 111.4-111.4 111.4zm0-192.8c-44.885 0-81.4 36.516-81.4 81.4s36.516 81.4 81.4 81.4 81.4-36.516 81.4-81.4-36.515-81.4-81.4-81.4z"></path>
                                        </svg>
                                    </a>
                                </li>
                                <li class="mobile-wishlist item-count">
                                    <a href="{{route('wishlist.index')}}">
                                        ...
                                        @auth
                                            <div class="item-count-contain wishlist-count">
                                                {{count(auth('web')->user()->wishlist)}}
                                            </div>
                                        @endauth
                                    </a>
                                </li>
                                <li class="mobile-cart item-count">
                                    <a href="{{route('cart.index')}}">
                                        <div class="cart-block">
                                            ...
                                            <div class="cart-item">
                                                <h5>{{__('titles.shopping cart')}}</h5>
                                            </div>
                                        </div>
                                    </a>
                                    <div class="item-count-contain cart-count">
                ...
                <div class="col-12">
                    <div class="navbar-menu">
                        <div class="logo-block">
                            <div class="brand-logo logo-sm-center">
                                <a href="{{url('/')}}">
                                    <img src="{{asset('images/layout-2/logo/logo.png')}}" class="img-fluid  "
                                         alt="logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="menu-block">
                            <nav id="main-nav">
                                ...
                                @foreach(\App\Models\MainCategory::active()->limit(5)->get() as $category)
                                    <!--HOME-->
                                        <li class="mega">
                                            <a class="dark-menu-item" href="javascript:void(0)">{{$category->name}}</a>
                                                                    ...
                                                                    <div class="col mega-box">
                                                                        <div class="link-section">
                                                                            <div class="menu-title">
                                                                                <h5>{{$child->name}}</h5></div>
                                                                            <div class="menu-content">
                                                                                <ul>
                                                                                    @if($child->hasChildren())
                                                                                        @foreach($category->children()->get() as $child)
                                                                                            <li>
                                                                                                <a href="{{url("shop?main_category=$category->slug&sub_category=$child->slug")}}">{{$child->name}}</a>
                                                                                            </li>
                                                                                        @endforeach
                                                                                    @endif
                                                                                </ul>
                        ...
                        @auth('web')
                            ...
                            <div class="category-right">
                                <div class="btn-group">
                                    <div class="gift-block" data-bs-toggle="dropdown" aria-expanded="true">

                                        <div class="gift-offer">
                                            <p>{{__('titles.customer')}}</p>
                                            <span>{{$user->name}}</span>
                                        </div>
                                    </div>
                                    <div class="dropdown-menu gift-dropdown"
                                         style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(0px, 73px);"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a href="{{route('user.dashboard')}}">
                                                    <h5 class="mt-0">{{__('titles.dashboard')}}</h5>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="media">
                                            <div class="me-3">
                                                <img src="{{asset('images/icon/1.png')}}" alt="dashboard">
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu gift-dropdown"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a href="{{route('login')}}">
                                                    <h5 class="mt-0">{{__('auth.login')}}</h5>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <a href="{{route('register')}}">
                                                    <h5 class="mt-0">{{__('auth.register')}}</h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
