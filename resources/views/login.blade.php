...
<g>
    ...
    <path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                            ...
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                       ...
                                       aria-selected="true"><span class="icon-user me-2"></span>{{__('titles.customer')}}</a>
                                </li>
                                    ...
                                    <form class="form-horizontal auth-form" method="post"
                                        ...
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                ...
                                                <a href="{{route('password.request')}}" class="btn btn-default forgot-pass">lost
                                                    your password</a>
                                            </div>
                                        </div>
                                        <div class="form-button">
                                            <button class="btn btn-primary" type="submit">{{__('btns.login as customer')}}</button>
                ...
                <!-- ================================= Seller ======================================== -->
                                ...
                                <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                    ...
                                    <form class="form-horizontal auth-form" method="post"
                                        ...
                                        <div class="form-button">
                                            <button class="btn btn-primary" type="submit">{{__('btns.login as seller')}}</button>
                                        </div>
                                        <div class="form-footer">
                                            <span>Or Login up with social platforms</span>
                                            <ul class="social">
            ...
            <a href="{{url()->previous() === url()->current() ? url('/') : url()->previous()}}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>back</a>
        </div>
    </div>
</div>
