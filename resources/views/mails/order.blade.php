    ...
    <tr>
        <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <img src="{{asset('images/email-temp/delivery.png')}}" alt="" style=";margin-bottom: 30px;">
                    </td>
                </tr>
                <tr>
                    <td>
                        <img src="{{asset('images/email-temp/success.png')}}" alt="">
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <img src="{{asset('images/email-temp/order-success.png')}}" alt="" style="margin-top: 30px;">
                    </td>
                </tr>
            </table>
            ...
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                ...
                <tr>
                    <td>
                        <img src="{{asset('storage').'/' . json_decode($item->images)[0]}}" alt="" width="70">
                    </td>
                    ...
                    <td valign="top" style="padding-left: 15px;">
                        <h5 style="font-size: 14px; color:#444;margin-top:15px;    margin-bottom: 0px;">Size :
                            <span> L</span></h5>
                        <h5 style="font-size: 14px; color:#444;margin-top: 10px;">QTY : <span>{{$item->pivot->quantity}}</span></h5>
                    </td>
                    <td valign="top" style="padding-left: 15px;">
                        <h5 style="font-size: 14px; color:#444;margin-top:15px"><b>${{$item->pivot->price}}</b></h5>
                    </td>
                </tr>
                @endforeach
                ...
                <tr>
                    ...
                    <td colspan="3" class="price"
                        style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;">
                        <b>{{$order->shipping_charge >0 ? '$' .$order->shipping_charge : 'Free'}}</b></td>
                </tr>
                <tr>
                    <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;
                                    padding-left: 20px;text-align:left;border-right: unset;">
                ...
                <tr>
                    <td style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                        ...
                        <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">
                            268 Cambridge Lane New Albany,<br> IN 47150268 Cambridge Lane <br>New Albany, IN 47150</p>
                    </td>
                    <td width="57" height="25" class="user-info"><img src="{{asset('images/email-temp/space.jpg')}}"
                                                                      alt=" " height="25" width="57"></td>
                    <td class="user-info"
    ...
    <tr>
        <td style="padding: 30px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon" align="center"
                ...
                <tr>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/facebook.png')}}" alt=""></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/youtube.png')}}" alt=""></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/twitter.png')}}" alt=""></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/gplus.png')}}" alt=""></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/linkedin.png')}}" alt=""></a>
                    </td>
                    <td>
                        <a href="#"><img src="{{asset('images/email-temp/pinterest.png')}}" alt=""></a>
                    </td>
                </tr>
            </table>
