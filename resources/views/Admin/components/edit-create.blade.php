                            ...
                            <div class="tab-pane show" id="banner" aria-labelledby="account-tab">
                                ...
                                @foreach($writables as $attr => $key)
                                    ...
                                    @if(in_array($type, generalInputs()))
                                        @if(count($languages) > 0 && in_array($attr, $translables)) <!-- Start If language -->
                                        ...
                                        @elseif($type === 'textarea')
                                            @if(count($languages) > 0 && in_array($attr, $translables))
                                                @foreach($languages as $index => $lang )
                                                    @isset($item) <!-- check if it's edit page -->
...
@section('extra-js')
    ...
    <script> $('#lfm').filemanager('image',{prefix: '/admin/filemanager'});</script>
    <!--ck editor-->
